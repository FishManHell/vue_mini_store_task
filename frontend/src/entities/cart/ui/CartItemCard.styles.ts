export const styles = {
  ...
  thumbnailWrap:
    'h-20 w-20 shrink-0 overflow-hidden rounded-xl bg-surface-hover sm:h-24 sm:w-24',
  ...
  link:
    'text-base font-semibold text-primary no-underline transition-colors hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-md line-clamp-2',
